...
public class MMSInputStream extends InputStream {
     ...
     * This is a conversion method used by libmms.
     * 
     * private static String unicode2string( byte[] bytes ) { try { String ret =
     * new String( bytes, CHARSET_NAME_UNICODE ); Log.d( LOG,
     * "unicode2string(): '" + ret + "'" );
     * 
     * return ret; } catch (java.io.UnsupportedEncodingException e) { Log.e(
     * LOG, "Cannot convert unicode --> string", e ); throw new
     * RuntimeException( e ); } }
     */
