...
// KEEP INCLUDES END
/**
 * Entity mapped to table NOTICIA_ENTITY.
 */
public class NoticiaEntity {
    ...
    public NoticiaEntity(Long id) {
	this.id = id;
    }

    public NoticiaEntity(Long id, String title, String author, String link, String imageURL, String description, java.util.Date date, boolean favorite,
	    boolean widget) {
	this.id = id;
	this.title = title;
	this.author = author;
