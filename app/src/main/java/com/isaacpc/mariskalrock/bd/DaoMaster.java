...
public class DaoMaster extends AbstractDaoMaster {
	...
	NoticiaEntityDao.createTable(db, ifNotExists);
	PodcastEntityDao.createTable(db, ifNotExists);
	VideoEntityDao.createTable(db, ifNotExists);
    }

    /** Drops underlying database table using DAOs. */
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
	NoticiaEntityDao.dropTable(db, ifExists);
	PodcastEntityDao.dropTable(db, ifExists);
	...
	registerDaoClass(NoticiaEntityDao.class);
	registerDaoClass(PodcastEntityDao.class);
